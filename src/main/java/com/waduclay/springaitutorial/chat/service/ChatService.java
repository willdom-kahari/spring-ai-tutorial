package com.waduclay.springaitutorial.chat.service;
...
public interface ChatService {
    ...
    /**
     * Generates an AI response using context injection (prompt stuffing) technique.
     * This method demonstrates how to inject additional context into prompts to provide
     * the AI with relevant information for more accurate and informed responses.
     *
     * @param message the input message/prompt for the AI
     * @param stuffit flag indicating whether to inject additional context into the prompt
     * @return ApiResponse containing AI response with or without context injection
     */
